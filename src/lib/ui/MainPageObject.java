...
public class MainPageObject {
    ...
    public WebElement waitForNestedElementPresent(WebElement element, By by, long timeoutInSeconds) {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        try {
    ...
    public String waitForWebElementAndGetAttribute(By by, String attribute, String error_message, long timeout_in_seconds) {
